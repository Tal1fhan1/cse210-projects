...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        Console.Clear();
        word._versesToSplit.Add(scripture.GetRandomVerse());
        word.SplitWords();
        ...
        while (answer != "quit")
        {
            ...
            Console.Clear();
            if (word._usedIndexes.Count() == word._wordsInVerse.Count())
            {
                answer = "quit";
            }
        }
